...
function Relation(options) {
  ...
  assert(this.type in Relation.Types, 'Invalid relation type: ' + this.type);
  this.modelFrom = options.modelFrom;
  this.keyFrom = options.keyFrom;
  this.modelTo = options.modelTo;
  this.keyTo = options.keyTo;
  this.modelThrough = options.modelThrough;
